...
name: brain
description: >-
  Procedures for the brain memory engine (brain.mjs): the md-first contract, the session-start read order, write discipline, the removal decision tree, and pointers to the install/admin/upgrade ceremonies. Use at session start, before any brain write, and before removing any node.
---
<!-- materialized from brain: brain -->
